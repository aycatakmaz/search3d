...
from search3d.dense_feature_computation.semantic_sam.utils.arguments import load_opt_from_config_file

from search3d.dense_feature_computation.semantic_sam.semantic_sam.BaseModel import BaseModel
from search3d.dense_feature_computation.semantic_sam.semantic_sam import build_model
from search3d.dense_feature_computation.semantic_sam.tasks.automatic_mask_generator import SemanticSamAutomaticMaskGenerator
from search3d.dense_feature_computation.semantic_sam.tasks.interactive_idino_m2m_auto import show_anns
from search3d.dense_feature_computation.semantic_sam.tasks.interactive_predictor import SemanticSAMPredictor
...
def prepare_image(image_pth):
    ...
    t.append(transforms.Resize(640, interpolation=transforms.InterpolationMode.BICUBIC))
...
def build_semantic_sam(model_type, ckpt, config_root="configs/"):
    """
    build model
    """
    cfgs={'T':os.path.join(config_root, "semantic_sam_only_sa-1b_swinT.yaml"),
          'L':os.path.join(config_root, "semantic_sam_only_sa-1b_swinL.yaml")}
