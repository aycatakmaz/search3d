...
import search3d.mask_feature_computation.big_vision_siglip.big_vision.evaluators.common as eval_common
import search3d.mask_feature_computation.big_vision_siglip.big_vision.evaluators.proj.distill.distance as dd
import search3d.mask_feature_computation.big_vision_siglip.big_vision.input_pipeline as input_pipeline
import search3d.mask_feature_computation.big_vision_siglip.big_vision.optax as bv_optax
import search3d.mask_feature_computation.big_vision_siglip.big_vision.utils as u
...
def main(argv):
  ...
  for m in config.get("pp_modules", ["ops_general", "ops_image", "ops_text"]):
    importlib.import_module(f"search3d.mask_feature_computation.big_vision_siglip.big_vision.pp.{m}")
  ...
  def get_model_mod(name):  # Used many times.
    ...
    return importlib.import_module(f"search3d.mask_feature_computation.big_vision_siglip.big_vision.models.{mod_name}")
