...
import search3d.mask_feature_computation.big_vision_siglip.big_vision.sharding as bv_sharding
...
################################################################################
  ...
  model_mod = importlib.import_module(f"search3d.mask_feature_computation.big_vision_siglip.big_vision.models.{config.model_name}")
