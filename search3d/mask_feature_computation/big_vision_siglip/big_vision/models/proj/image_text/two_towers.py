  ...
  def __call__(self, image, text=None, **kw):
    ...
    if text is not None:
      text_model = importlib.import_module(
          f"search3d.mask_feature_computation.big_vision_siglip.big_vision.models.{self.text_model}"
    ...
    if image is not None:
      image_model = importlib.import_module(
          f"search3d.mask_feature_computation.big_vision_siglip.big_vision.models.{self.image_model}"
...
def load(init_params, init_files, model_cfg, img_load_kw={}, txt_load_kw={}):  # pylint: disable=dangerous-default-value
  ...
  if img_init:
    restored_params["img"] = importlib.import_module(
        f"search3d.mask_feature_computation.big_vision_siglip.big_vision.models.{model_cfg.get('image_model', 'vit')}"
  ...
  if txt_init:
    restored_params["txt"] = importlib.import_module(
        f"search3d.mask_feature_computation.big_vision_siglip.big_vision.models.{model_cfg.get('text_model', 'proj.image_text.text_transformer')}"  # pylint: disable=line-too-long
