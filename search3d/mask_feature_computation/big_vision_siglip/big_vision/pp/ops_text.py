...
from search3d.mask_feature_computation.big_vision_siglip.big_vision.datasets.imagenet import class_names as imagenet_class_names
from search3d.mask_feature_computation.big_vision_siglip.big_vision.pp import ops_general
from search3d.mask_feature_computation.big_vision_siglip.big_vision.pp import utils
from search3d.mask_feature_computation.big_vision_siglip.big_vision.pp.registry import Registry
...
def create_tokenizer(model="c4_en", add_eos=True, load_from_file_path=None):
  if len(load_from_file_path) > 0:
    with open(load_from_file_path, "rb") as f:
      model = f.read()
  else:
...
def get_pp_tokenize(
  ...
  tokenizer = create_tokenizer(model, add_eos=eos != "none", load_from_file_path=load_from_file_path)
